 ...
 */(function () {
    var e = /\blang(?:uage)?-(?!\*)(\w+)\b/i, t = self.Prism = {
        ...
        highlight: function (e, r, i) {return n.stringify(t.tokenize(e, r), i)},
    ...
    n.stringify = function (e, r, i) {
        ...
        if (Object.prototype.toString.call(e) == "[object Array]")return e.map(function (t) {return n.stringify(t, r, e)}).join("");;
        var s = {
            type: e.type,
...
Prism.hooks.add("wrap", function (e) {e.type === "entity" && (e.attributes.title = e.content.replace(/&amp;/, "&"))});;
Prism.languages.css = {
    comment: /\/\*[\w\W]*?\*\//g,
