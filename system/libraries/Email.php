...
// ------------------------------------------------------------------------
    ...
    class CI_Email
    {
        ...
        var $_attach_type = [];
        var $_attach_disp = [];
        var $_protocols = ['mail', 'sendmail', 'smtp'];
        var $_base_charsets = ['us-ascii', 'iso-2022-'];    // 7-bit charsets (excluding language suffix)
        var $_bit_depths = ['7bit', '8bit'];
        var $_priorities = ['1 (Highest)', '2 (High)', '3 (Normal)', '4 (Low)', '5 (Lowest)'];
