...
// ------------------------------------------------------------------------
    ...
    class CI_Cart
    {
        ...
        function _insert($items = [])
        {
            ...
            // --------------------------------------------------------------------
            // validateForm the product ID. It can only be alpha-numeric, dashes, underscores or periods
            ...
            // --------------------------------------------------------------------
            // validateForm the product name. It can only be alpha-numeric, dashes, underscores, colons or periods.
