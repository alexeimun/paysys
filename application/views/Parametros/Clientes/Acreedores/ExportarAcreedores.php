                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" id="nombre" class="form-control obligatorio"
                               ...
                               value="Lista Acreedores <?= date('d-m-Y') ?>" style="text-align: center;">
                    </div>
                </div>
            </form>
    ...
    $(document).ready(function ()
    {
        ...
        $(':button').on('click', function ()
        {
            $.ajax({
                ...
                {
                    ArmarTabla(data);
                    $('div.content-header').html('<div class="callout callout-info no-margin"> <h4>Éxito!</h4>Se ha exportado un libro de excel con los acreedores</div>').hide().show(700);
                }
            });
        });
        function ArmarTabla(tabla)
        {
            ...
            if (nombre == '')nombre = 'Listado Acreedores <?=date('d-m-Y') ?>';
            else
            {
