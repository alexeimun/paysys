                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 style="text-align: center;color: #3c8dbc;"><span style="font-size: 25pt;" class="ios ion-android-list"></span>&nbsp; Listado Solicitudes</h3>
                        </div>
                        <div class="box-body">
                            <?= $Solicitudes ?>
                        </div>
    ...
    function eliminar(Id) {
        BootstrapDialog.show({
            ...
            buttons: [{
                ...
                cssClass: 'btn-danger',
                action: function () {
                    $.post('<?=site_url('eliminarSolicitud') ?>', {Id: Id}, function ()
                    {
